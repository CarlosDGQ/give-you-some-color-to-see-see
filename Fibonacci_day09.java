 ...
 * 扩展3：我们可以用2*1的小矩形横着或者竖着去覆盖更大的矩形。请问用n个2*1的小矩形无重叠地覆盖一个2*n的大矩形，总共有多少种方法？
 * 思路：用1个2*1的去覆盖1个2*1的有一种方法；用2个2*1的去覆盖2个2*1的有两种方法；
 * 用3个2*1的去覆盖3个2*1的有三种方法；用4个2*1的去覆盖4个2*1的有五种方法；
 * 类推还是斐波那契数列。
 * */
